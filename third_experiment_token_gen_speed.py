...
def evaluation_fn(model):
    ...
    token_generation_speeds = wikitext_benchmark.evaluate_token_generation_speed(
    ...
    return {
        "token_generation_stats": token_generation_speeds,
    }


with torch.no_grad():
    originial_model_benchmarks = evaluation_fn(model)
...
log = {
    ...
    "original_model_benchmarks": originial_model_benchmarks,
